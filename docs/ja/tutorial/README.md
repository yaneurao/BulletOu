...
| 2 | [NNUE チュートリアル](2-nnue-tutorial.md) | 実データから将棋 NNUE を学習する流れを丁寧に追う |
| 3 | [KPPT / KPP_KKPT 学習](3-kppt-roadmap.md) | やねうら王の旧評価関数の学習 (Phase 1〜4 実装済み) |

チュートリアルを読み終えたあとは、仕様レベルの詳細 (データフォーマット、出力フォーマットなど) は [リファレンス](../0-contents.md) を参照。
