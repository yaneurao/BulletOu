...
| `SFNN_HALFKA2HM` | やねうら王 NNUEwoSQPT1536 用 (HalfKA_hm2 + LayerStacks=9 + SqrCReLU + PSQT shortcut)。詳細は [§9 SFNN-1536](9-sfnn-1536.md) | `nn.bin` (Phase 4 実装中) | 使う (1536x2-15-32 のみ) |
| `SFNN_HALFKA1HM` | ↑ の HalfKA_hm1 (v1) アブレーション版 | `nn.bin` (同上) | 使う (1536x2-15-32 のみ) |
