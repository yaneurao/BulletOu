...
| `SFNN_HALFKA2HM` | やねうら王 NNUEwoSQPT1536 用。HalfKA_hm2 + LayerStacks=9 + SqrCReLU + PSQT shortcut の構成。詳細は [SFNN-1536 学習](9-sfnn-1536.md) | `nn.bin` (Phase 4 で実装中) |
| `SFNN_HALFKA1HM` | ↑ の HalfKA_hm1 (v1、後手玉 collapse なし) アブレーション版 | `nn.bin` (同上) |
