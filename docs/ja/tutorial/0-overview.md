...
- [2. 学習を走らせる](2-train.md) — 実データで評価関数を学習する (eval-type / 教師 / コマンド)
- [3. 学習をチューニング](3-tune.md) — スケジュールと教師ターゲット (`--lambda`) の調整 (任意)
- [4. 結果を確認・活用する](4-result.md) — 出力レイアウト、`learn.log` の読み方、エンジンへの組み込み
