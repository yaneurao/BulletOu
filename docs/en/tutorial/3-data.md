...
| `SFNN_HALFKA2HM` | YaneuraOu NNUEwoSQPT1536 family (HalfKA_hm2 + LayerStacks=9 + SqrCReLU + PSQT shortcut). See [§9 SFNN-1536](9-sfnn-1536.md). | `nn.bin` | yes (1536x2-15-32 only) |
| `SFNN_HALFKA1HM` | Same as above but with HalfKA_hm1 (v1) for ablation. | `nn.bin` | yes (1536x2-15-32 only) |
