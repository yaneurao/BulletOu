...
| 3 | [Run the training](3-train.md) | Create `bulletou-settings.json` and start training with `--settings-file` |
| 4 | [Enable validation](4-validation.md) | Add `test_teacher` and `validation_rate` to watch accuracy / loss |
