...
| `--lr` / `--lr-schedule` / `--lr-min` | LR scheduler (`step_gamma` = tatara/bullet-shogi-compatible StepLR, `step` = geometric, `cos` = cosine, details in [§6.1](../tutorial/6-tune.md#61-training-schedule)) | 0.000875 / `step_gamma` / 0.00001 |
