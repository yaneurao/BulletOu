...
The closely-related `--arch SFNN_ka2_1536_15_32_k3k3` trains the same input feature with the SFNN-1536 architecture (LayerStacks=9, see [§4.4](../tutorial/4-train.md) and [SFNN-1536](sfnn-1536.md)).
