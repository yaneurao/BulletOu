...
| `SFNN_halfkahm1_<FT>_<H1>_<H2>[_cN_sMxG][_<stack>]` | `SFNN_HALFKA1HM` | SFNN / optional LayerStacks | `nn.bin` | ablation / experimental |
| `SFNN_halfkahm2_<FT>_<H1>_<H2>[_cN_sMxG][_<stack>]` | `SFNN_HALFKA2HM` | SFNN / optional LayerStacks | `nn.bin` | yes, with matching YaneuraOu SFNN build |
| `SFNN_halfka2_<FT>_<H1>_<H2>[_cN_sMxG][_<stack>]` | `SFNN_HALFKA2` | SFNN / optional LayerStacks | `nn.bin` | yes, with matching `YANEURAOU_ENGINE_SFNN_halfka2_*` build |
| `SFNN_ka2_<FT>_<H1>_<H2>[_cN_sMxG][_<stack>]` | `SFNN_KA2` | SFNN / optional LayerStacks | `nn.bin` | yes, with matching `YANEURAOU_ENGINE_SFNN_ka2_*` build |
...
Therefore `--arch SFNN_ka2_8192_7_64_c0_s1024x8_k3k3` unambiguously means target
...
```text
SFNN_<feature>_<FT>_<H1>_<H2>[_cN_sMxG][_<stack>]
```
...
If `<stack>` is omitted, BulletOu uses a single stack (`LayerStacks = 1`) and
all positions use bucket `0`. Otherwise `<stack>` selects the
YaneuraOu-compatible LayerStack bucket algorithm:
...
| `--arch SFNN_halfka2_1024_7_64` | `checkpoints/SFNN_HALFKA2-SFNN_halfka2_1024_7_64` |
| `--arch SFNN_halfka2_1024_7_64_k3k3` | `checkpoints/SFNN_HALFKA2-SFNN_halfka2_1024_7_64_k3k3` |
| `--arch SFNN_ka2_8192_7_64_c0_s1024x8_k3k3` | `checkpoints/SFNN_KA2-SFNN_ka2_8192_7_64_c0_s1024x8_k3k3` |
