...
pub use shogi_shardkp::{
    ...
    SHARDKP_FANOUT, SHARDKP_MAX_ACTIVE, SHARDKP_SHARD_COUNT, SHARDKP_SHARD_DIMENSIONS, SHARDKP_TOTAL_L1, ShogiShardKp,
    connection_index as shardkp_connection_index, shard_for_feature as shardkp_shard_for_feature,
};
